...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('jenis_cuti.update', ['jenis_cuti' => $jenis_cuti->id]) }}" method="POST"
                ...
                <div class="row">
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('nama_jenis_cuti') is-invalid @enderror"
                            name="nama_jenis_cuti" id="nama_jenis_cuti"
                            value="{{ old('nama_jenis_cuti') ?? $jenis_cuti->nama_jenis_cuti }}"
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="number" class="form-control @error('jatah') is-invalid @enderror" name="jatah"
                            id="jatah" value="{{ old('jatah') ?? $jenis_cuti->jatah }}" placeholder="Enter Jatah">

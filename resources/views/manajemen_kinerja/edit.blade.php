...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('manajemen_kinerja.update', ['manajemen_kinerja' => $manajemen_kinerja->id]) }}"
                ...
                <div class="row">
                        ...
                        <select id="nik" name="nik"
                            ...
                            @foreach ($data_karyawan as $item)
                                <option value="{{ $item->nik }}"
                                    {{ $item->nik == $manajemen_kinerja->nik ? 'selected' : null }}>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <select id="jenis" name="jenis" class="form-control @error('jenis') is-invalid @enderror">
                            ...
                            <option value="Reward"
                                {{ old('jenis') ?? $manajemen_kinerja->jenis == 'Reward' ? 'selected' : '' }}>Reward
                            </option>
                            <option value="Punishment"
                                {{ old('jenis') ?? $manajemen_kinerja->jenis == 'Punishment' ? 'selected' : '' }}>Punishment
                            </option>
                        </select>
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="file" class="form-control @error('foto') is-invalid @enderror" id="foto"
                            name="foto" value="{{ old('foto') ?? $manajemen_kinerja->foto }}" placeholder="Enter Foto">
                        @if (!$errors->has('foto'))
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('alasan') is-invalid @enderror" name="alasan"
                            id="alasan" value="{{ old('alasan') ?? $manajemen_kinerja->alasan }}"
                    ...
                    <div class="form-group col-lg-12 col-md-12 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('catatan') is-invalid @enderror" name="catatan"
                            id="catatan" value="{{ old('catatan') ?? $manajemen_kinerja->catatan }}"

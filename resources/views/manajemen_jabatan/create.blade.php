...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('manajemen_jabatan.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <select id="jenis" name="jenis" class="form-control @error('jenis') is-invalid @enderror">
                            ...
                            <option value="Promosi" {{ old('jenis') == 'Promosi' ? 'selected' : '' }}>Promosi</option>
                            <option value="Mutasi" {{ old('jenis') == 'Mutasi' ? 'selected' : '' }}>Mutasi</option>
                            <option value="Demosi" {{ old('jenis') == 'Demosi' ? 'selected' : '' }}>Demosi</option>
                        </select>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <input type="text" class="form-control @error('devisi_lama') is-invalid @enderror"
                            name="devisi_lama" id="devisi_lama" value="{{ $devisi }}" readonly>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <input type="text" class="form-control @error('jabatan_lama') is-invalid @enderror"
                            name="jabatan_lama" id="jabatan_lama" value="{{ $jabatan }}" readonly>
                        ...
                        <select id="devisi_baru" name="devisi_baru"
                            ...
                            @foreach ($devisis as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('devisi_baru') == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6">
                        ...
                        <select id="jabatan_baru" name="jabatan_baru"
                            ...
                            @foreach ($jabatans as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('jabatan_baru') == $item->id ? 'selected' : '' }}>
